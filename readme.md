# cryptocurrencies [![Build Status](https://travis-ci.org/radiovisual/cryptocurrencies.svg?branch=master)](https://travis-ci.org/radiovisual/cryptocurrencies)
...
<!-- BEGIN TABLE INJECT -->
There are currently **1238 cryptocurrencies** represented*:
